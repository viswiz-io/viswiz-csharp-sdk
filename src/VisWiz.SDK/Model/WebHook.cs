...
namespace VisWiz.SDK.Model
{
    ...
    public partial class WebHook :  IEquatable<WebHook>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="createdAt">The date and time the webhook was created.</param>
        /// <param name="name">The webhook name.</param>
        /// <param name="url">The webhook URL.</param>
        public WebHook(DateTime? createdAt = default(DateTime?), string name = default(string), string url = default(string))
        {
        ...
        /// </summary>
        /// <value>The date and time the webhook was created</value>
