...
namespace VisWiz.SDK.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "viswiz-csharp-sdk/1.0.0";
            BasePath = "https://api.viswiz.io";
        ...
        public Configuration(
            ...
            string basePath = "https://api.viswiz.io") : this()
        {
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "viswiz-csharp-sdk/1.0.0"
        ...
        {
            String report = "C# SDK (VisWiz.SDK) Debug Report:\n";
