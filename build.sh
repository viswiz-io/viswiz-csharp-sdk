...
${nuget_cmd} install src/VisWiz.SDK/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/VisWiz.SDK.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/VisWiz.SDK.dll \
-recurse:'src/VisWiz.SDK/*.cs' \
-doc:bin/VisWiz.SDK.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/VisWiz.SDK.dll was created successfully"
fi
